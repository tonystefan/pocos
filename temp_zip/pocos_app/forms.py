        ...
        if max_horimetro_diario and max_horimetro_diario > 0:
            ...
            if data_inicio and data_fim:
                ...
                while data_atual <= data_fim:
                    # O Django DateField retorna um objeto date, mas o strftime usa o locale do sistema.
                    # Para garantir a compatibilidade, vamos usar o número do mês e mapear para as chaves
                    # usadas na lista MESES (jan, fev, mar, etc.).
                    
                    # Mapeamento de número do mês para a chave de 3 letras (pt-br)
                    meses_map = {
